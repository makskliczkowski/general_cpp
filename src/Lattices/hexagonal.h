/******************************************************************************
 *
 *  @file src/lattices/hexagonal.h
 *  @brief Hexagonal lattice class declaration.
 *
 *  @project general_cpp
...
public:
	...
	HexagonalLattice(int Lx, int Ly = 1, int Lz = 1, int dim = 1, int _BC = 0);
...
public:
	v_1d<uint> get_flux_sites(int X, int Y, int Z = 0) const override final;
};
